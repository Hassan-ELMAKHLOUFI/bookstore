...
class __TwigTemplate_aa18d15b587bc0c328ef153aee82b398f8d989e922f458e8257a59402815e6a2 extends Template
{
    private $source;
    private $macros = [];
...
{% if pageCount > 1 %}
    <div class=\"pagination\">
        ...
        {% if previous is defined %}
            <span class=\"previous\">
                <a class=\"page-link\" rel=\"prev\" href=\"{{ path(route, query|merge({(pageParameterName): previous})) }}\">&lt;</a>
            </span>
        {% endif %}
        ...
        {% if next is defined %}
            <span class=\"next\">
                <a class=\"page-link\" rel=\"next\" href=\"{{ path(route, query|merge({(pageParameterName): next})) }}\">&gt;</a>
            </span>
        {% endif %}
...
{% endif %}
", "@KnpPaginator/Pagination/sliding.html.twig", "/Users/softedel/Documents/GitHub/bookstore/vendor/knplabs/knp-paginator-bundle/templates/Pagination/sliding.html.twig");
    }
}
